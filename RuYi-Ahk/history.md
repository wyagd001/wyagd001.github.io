...
### <span id="2.5">2.5 - 2024/03/XX</span>
...
5. 新增 长按右键2秒以上显示面板或菜单的功能  
6. 新增 语音动作, Win10+ 系统按下快捷键(默认 Alt+F3)后, 按说出的动作名称执行动作  
7. 新增 内部动作  
.01 将选中文件添加为自定义动作  
...
.16 语音动作.ahk2  运行后使用 Bing 语音进行麦克风语音识别, 然后按说出的动作名称打开动作(需安装webview2)  
.17 显示输入法状态.ahk2  
.18 时间_天数计算.ahk  
