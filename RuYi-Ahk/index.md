...
**脚本下载**: [https://wyagd001.github.io/RuYi-Ahk/RuYi.zip_2.6](https://wyagd001.github.io/RuYi-Ahk/RuYi.zip)  

**当前版本**: [2.6 - 2024/05/19](history.md)
...
#### <span id="script">外部脚本</span>
  - 许多动作是由外部的 ahk 脚本来完成的, 它们统一放在 "外部脚本" 目录. 外部脚本在动作中最多支持 3 个命令行参数, 并且支持如意内置的[变量](./var.md). 现在内置的外部动作脚本有 251 个.  
