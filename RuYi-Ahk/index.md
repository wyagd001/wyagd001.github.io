...
|1220|是|[放入剪贴板](/Actions/1220.md)|选中文件|将选中的文本文件内容放入剪贴板|文本文件内容放入剪贴板.ahk|
...
|1224|是|[Edge收藏夹](/Actions/1223.md)|无条件|将 Edge 浏览器的收藏夹显示为菜单|MsEdge收藏夹.ahk|
...
|1239|否|[收藏夹](/Actions/1239.md)|对话框|对话框跳转到ini文件中预设的文件夹|对话框_打开目录.ahk|
