...
**当前版本**: [1.5 - 2023/02/21](history.md)
...
#### <a id="Script">外部脚本</a>
  - 许多动作是由外部的 ahk 脚本来完成的, 它们统一放在 "外部脚本" 目录. 现在内置的外部动作脚本有 88 个.  
...
|1226|是|打开的|对话框|显示一个现在打开的文件夹的菜单对话框跳转到选择的项目|
|1228|是|搜狗翻译|选中文本|使用搜狗翻译选中的文本|
|1231|否|环境变量|无条件|环境变量编辑备份脚本|
|1232|是|新增Path|资源管理器|将资源管理器当前打开的路径加入环境变量Path中|
